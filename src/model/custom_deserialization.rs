    ...
    D: Deserializer<'de>,
{
    ...
    where T: Deserialize<'de> + FromStr<Err = Void>
    {
        ...
        fn expecting(&self, formatter: &mut fmt::Formatter) -> fmt::Result { formatter.write_str("null, string or map") }
    ...
    D: Deserializer<'de>,
{
    ...
    where T: Deserialize<'de> + FromStr<Err = Void>
    {
        ...
        fn expecting(&self, formatter: &mut fmt::Formatter) -> fmt::Result { formatter.write_str("string or map") }
